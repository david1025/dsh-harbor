; Build the framework-dependent arm64 release before compiling this script:
; dotnet publish .\DSHHarbor\DSHHarbor.csproj -c Release -r win-arm64 --self-contained false -o .\artifacts\win-arm64
...
[Setup]
AppId={{E7415235-805D-4B5F-91F7-5F23E25E8B66}
AppName={#MyAppName}
...
OutputBaseFilename=DSHHarborSetup-0.1.9-arm64
Compression=lzma2
...
[Files]
Source: "..\artifacts\win-arm64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
...
[Code]
const
  DotNetRuntimeUrl = 'https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/10.0.8/windowsdesktop-runtime-10.0.8-win-arm64.exe';
  DotNetRuntimeFile = 'windowsdesktop-runtime-10.0.8-win-arm64.exe';
  DotNetRuntimeSha256 = '956f73a3a17b549acc55ffb694f8aeb82ff8ccdba8eee263a6a9195577dd8733';
